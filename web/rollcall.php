                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">Ögreci Listesi</h4>

                                    <table id="datatable" class="table table-bordered">
                                        <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Ögrenci adı ve soyadı</th>
                                            <th>Yokalama tarihi</th>

                                        </tr>
                                        </thead>
                                        <?php
                                        $query = "SELECT rolls, names, MIN(current_data) AS current_data
                                                    FROM edituser
                                                    GROUP BY rolls, names, DATE(current_data)";
                                        ...
                                        <?php foreach ($users as $user): ?>
                                            <tr>
                                                <td><?php echo htmlspecialchars($user['rolls']); ?></td>
                                                <td><?php echo htmlspecialchars($user['names']); ?></td>
                                                <td><?php echo htmlspecialchars($user['current_data']); ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
